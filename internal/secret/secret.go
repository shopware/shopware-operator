...
func GenerateStoreSecret(ctx context.Context, store *v1.Store, secret *corev1.Secret, p []byte) error {
	if secret.Data == nil {
	...
	secret.Data["database-url"] = util.GenerateDatabaseURLForShopware(&store.Spec.Database, p)
